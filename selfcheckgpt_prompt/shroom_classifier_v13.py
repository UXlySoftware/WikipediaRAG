...
"""
    ...
    def __init__(self, model_name="gpt-4", temperature=0.1, examples_per_class=1, example_selection=0, api_key=None):
        """
        ...
        Parameters:
            ...
            api_key: The OpenAI API key (optional if set as an environment variable).
        """
        self.model_name = model_name
        self.temperature = temperature
        if api_key:
            import os
            os.environ["OPENAI_API_KEY"] = api_key  # Set API key as an environment variable
